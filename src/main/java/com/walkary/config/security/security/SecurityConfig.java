...
public class SecurityConfig {
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOriginPatterns(Arrays.asList("http://walkary.kro.kr", "https://walkary.kro.kr", "http://*.walkary.fun", "https://*.walkary.fun", "http://localhost:5173", "https://localhost:5173", "http://mywalkarybucket.s3-website.ap-northeast-2.amazonaws.com"));
